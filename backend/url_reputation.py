...
class SSLInspector:
    ...
    async def inspect_certificate(self, domain: str) -> SSLInfo:
        ...
        try:
            ...
            org_match = self._check_organization_match(domain, organization, common_name)
...
class URLReputationService:
    ...
    def __init__(
        ...
        self._domain_age_checker = DomainAgeChecker() if enable_domain_age_check else None
